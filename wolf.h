...
//Class of the wolf enemy within the tutorial area. 
class WolfMob : public Enemy {
public:
	//"wolf.png" is referenced to the wolf's spritesheet that I re-edited so that it would work. 
	WolfMob(Map *map, float x, float y) : Enemy(map, "wolf.png", x, y, sf::IntRect(0, 0, 128, 65)) { //intrect determines what the size of each frame of animation of the wolf
		this->health = 1; 
