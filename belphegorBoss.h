...
//Class of the Boss Belphegor but he's an enemy within the Volcano area. 
class BelphegorBoss : public Enemy {
public:
	//".png" is referenced to the tsuna's spritesheet that I re-edited so that it would work. 
	BelphegorBoss(Map *map, float x, float y) : Enemy(map, "belphegordefault.png", x, y, sf::IntRect(0, 0, 128, 65)) { //HAVENT ANIMATED OR ADD THIS MOB TO THE MAP.CPP PART YET
		this->health = 25; 
