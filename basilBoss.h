...
//Class of the Boss Basil but he's an enemy within the Desert area. 
class BasilBoss : public Enemy {
public:
	//".png" is referenced to the tsuna's spritesheet that I re-edited so that it would work. 
	BasilBoss(Map *map, float x, float y) : Enemy(map, "basildefault.png", x, y, sf::IntRect(0, 0, 128, 65)) { //HAVENT ANIMATED OR ADD THIS MOB TO THE MAP.CPP PART YET
		this->health = 15; 
